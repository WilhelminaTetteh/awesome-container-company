  ...
  return (
    <section className="about" id="about">
      ...
      <div className="about__visual">
        <img src={image1} alt="" className="about__image about__image_1" />
        <img src={image2} alt="" className="about__image about__image_2" />
        <img src={image3} alt="" className="about__image about__image_3" />
        <img src={image4} alt="" className="about__image about__image_4" />
        <p className="about__text about__text_1">
          01.
          <br />Restaurants request reusable containers via app
        </p>
